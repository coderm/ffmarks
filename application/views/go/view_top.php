...
<head>
<title><?php echo $title.' | '.$this->config->item('title'); ?></title>
<meta content="text/html; charset=utf-8" />
<base href="<?php echo base_url(); ?>" />
<link rel="stylesheet" href="<?php echo base_url(); ?>public/style/screen-top.css" type="text/css" media="screen" />
...
<body>
	...
	<div id="content">
		<div id="logo"><a href="<?php echo base_url(); ?>" target="_parent" title="Return to ffmarks"><img src="public/img/logo-new.png" alt="Return to ffmarks" /></a></div>
